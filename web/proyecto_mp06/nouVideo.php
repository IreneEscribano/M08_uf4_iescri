                            ...
                            <form id="form_video">
                                <div class="row">  
                                    <div class="col-lg-6 col-md-6">
                                        <input type="text" name="nom" autocomplete="off" placeholder="Nom del vídeo">
                                    ...
                                    <button type="button" class="site-btn" onclick="pujarVideo(document.querySelector('#form_video').elements)">Pujar video</button>
                                </div>
                            </form>
                        </div>
                    </div>
